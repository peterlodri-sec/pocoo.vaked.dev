...
We built a [single-page guide site](https://peterlodri-sec.github.io/loopkit/) for LoopKit —
same style as [cobusgreyling.github.io/loop-engineering](https://cobusgreyling.github.io/loop-engineering/).
It includes the full loop pattern visualization, kompress results table, ecosystem links,
5 loops, 7 production patterns, and the Telegram bot setup — all on one page.
...
LoopKit and [Cobus Greyling's loop-engineering](https://github.com/cobusgreyling/loop-engineering)
are complementary. Here's how they fit:
...
Use Cobus's tools to **plan and audit** your loops. Use LoopKit to **run and scale** them.
Together they form the complete loop engineering stack.
